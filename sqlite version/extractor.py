...
#       myi+=1       
  ...
  #            print(indexvalues[p+1].start)
    ...
    #  if(flag["(57) Abstract"]!=1): 
      ...
      universal.data["Name of Applicant"] = formatstring(data["(71) Name Applicant"])
